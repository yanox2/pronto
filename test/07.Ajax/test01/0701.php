...
<div style="margin:10px 0;"><?=C_PR_HOME_PATH.'/test/07.Ajax/test01/sysdef_org.inc を読み込み'?></div>
...
//print 'lis = Object.create(MyLis,{items:'.$items.'});'."\n";
print 'lis = Object.create(MyLis,{});'."\n";
