...
class ClassC{
	...
	public function methodA(){
		print '<div style="margin:10px 0; font-size:14px; background-color:aliceblue;">ClassC - methodA</div>'."\n";
		$this->_method();
	}

	public function methodB(){
		print '<div style="margin:10px 0; font-size:14px; background-color:aliceblue;">ClassC - methodB</div>'."\n";
		$this->_method();
	}

	public function _method(){
		print '<div>・Dispatcher設定</div>'."\n";
		print '<div>C_PR_SUBSYS_URIROOT="'.\PR\SysEnv::getSubSysURIRoot().'"</div>'."\n";
