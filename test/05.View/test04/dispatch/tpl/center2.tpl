...
?>
<header>●ビュー2（ディスパッチあり）</header>
<article>
<section style="font-size:14px;">
<div style="margin:10px 0;"><?=$homeDir.'/test/05.View/test04/sysdef_org.inc を読み込み'?></div>

<div style="background-color:aliceblue;">
<div style="">methodType - <?=$type?></div>
<div style="margin:10px 0; font-size:14px; background-color:aliceblue;">template - tpl/test04.tpl</div>
</div>
