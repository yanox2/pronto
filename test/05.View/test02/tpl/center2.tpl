...
?>
<header>●ビュー2（Layout）</header>
<article>
<section style="font-size:14px;">
<div style="margin:10px 0;"><?=$homeDir.'/test/05.View/test02/sysdef_org.inc を読み込み'?></div>
